...
public class StartSceneBackgroundAFade : MonoBehaviour {
...
// --------------- PRIVATE VARIABLES ---------------
	// Fade Timer
	private float BackgroundImageATimer = 3.0f;
...
// ---------------------------------------- START: CALLING OTHER SCRIPTS ----------------------------------------
	// Disable Object
	public StartSceneEnable DisableBackgroundImageARun;
...
// --------------- UPDATE FUNCTION ---------------
	void Update() {
		...
		if (TimerTime >= BackgroundImageATimer) {
			StartCoroutine(BackgroundImageAFade(0.0f, 3.0f));
		}
