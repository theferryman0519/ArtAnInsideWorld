...
public class WarningSceneEnable : MonoBehaviour {
		
// ---------------------------------------- START: LIST OF VARIABLES ----------------------------------------
// --------------- PUBLIC VARIABLES ---------------
    public Image BackgroundImageB;
    public Text TitleText;
    public Image IUnderstandButton;
...
// --------------- ENABLE OBJECTS FUNCTIONS ---------------
    ...
    public void EnableIUnderstandButton() {
        IUnderstandButton.enabled = true;
    }
...
// --------------- DISABLE OBJECTS FUNCTIONS ---------------
    ...
    public void DisableIUnderstandButton() {
        IUnderstandButton.enabled = false;
    }
